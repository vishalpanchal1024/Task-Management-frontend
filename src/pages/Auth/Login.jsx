      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex flex-col items-center justify-center p-8 relative">
          ...
          <div className="relative">
            {/* Main circle */}
            <div className=" w-56 h-56 bg-gradient-to-br from-yellow-300 to-yellow-400 rounded-full flex items-center justify-center animate-float shadow-lg">
        ...
        <div className=" p-8 rounded-2xl shadow-lg backdrop-blur-sm bg-white/80">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">Enter Your Deatils</p>
          </div>
